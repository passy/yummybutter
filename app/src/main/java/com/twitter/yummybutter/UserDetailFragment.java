package com.twitter.yummybutter;
...
import com.twitter.yummybutter.dummy.DummyContent;
...
public class UserDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.user_name)).setText(mItem.content);
            final RecyclerView projectsList =
                    (RecyclerView) rootView.findViewById(R.id.user_projects_list);
